...
educationMediaApp
		.config(function($stateProvider, $urlRouterProvider) {
			...
			$stateProvider
					...
					.state(
							'manageAttendance.takeAttendance',
							{
					...
					.state(
							'manageAttendance.studentReport',
							{
								parent : 'manageAttendance',
					...
					.state(
							'manageAttendance.teacherReport',
							{
								parent : 'manageAttendance',
					...
					.state(
							'updateUserProfile',
							{
								...
								controller : 'update_user_profile',
								data : {
					...
					.state(
							'userSettings',
							{
								url : "/manage-users/user-settings",
								templateUrl : "partials/modules/manageUsers/userSettings.html",
								controller : 'userProfileChanges',
								data : {
